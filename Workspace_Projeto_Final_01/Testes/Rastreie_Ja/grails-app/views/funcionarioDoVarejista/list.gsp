	...
	<table class="table table-bordered">
		<thead>
			<tr>
              ...
              <th><g:message code="funcionarioDoVarejista.supervisorDoVarejista.label" default="Supervisor Do Varejista" /></th>
		...
		<g:each in="${funcionarioDoVarejistaInstanceList}" status="i" var="funcionarioDoVarejistaInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
			    ...
			    <td><g:link action="show" id="${funcionarioDoVarejistaInstance.id}">${fieldValue(bean: funcionarioDoVarejistaInstance, field: "supervisorDoVarejista")}</g:link></td>
