...
<section id="show-funcionarioDoVarejista" class="first">
	...
	<table class="table">
		<tbody>
			...
			<tr class="prop">
				<td valign="top" class="name"><g:message code="funcionarioDoVarejista.supervisorDoVarejista.label" default="Supervisor Do Varejista" /></td>
				
				<td valign="top" class="value"><g:link controller="supervisorDoVarejista" action="show" id="${funcionarioDoVarejistaInstance?.supervisorDoVarejista?.id}">${funcionarioDoVarejistaInstance?.supervisorDoVarejista?.encodeAsHTML()}</g:link></td>
