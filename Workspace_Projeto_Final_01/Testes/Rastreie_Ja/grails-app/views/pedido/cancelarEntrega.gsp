...
<body>
	...
	<g:form  name="cancelarEntrega">
			<g:actionSubmit class="btn btn-primary"  action="cancelarTudo" value="Cancelar Tudo" />
 	</g:form><br/><br/>
	
		
	<g:form url="[action:'_cancelarEntrega',controller:'pedido']" method = "post" >
			Número do Pedido: <input type = "text"                name   = "numPedido" /><br/>
						      <input type = "submit"              value  = "Cancelar Entrega" onclick="return confirm('${message(code: 'Tem certeza que deseja cancelar a entrega?', default: 'Tem certeza que deseja cancelar a entrega?')}');" >
	</g:form><br/><br/><br/><br/>
