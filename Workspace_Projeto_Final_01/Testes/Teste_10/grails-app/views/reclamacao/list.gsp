...
<html>
	...
	<body>
		<a href="#list-reclamacao" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-reclamacao" class="content scaffold-list" role="main">
