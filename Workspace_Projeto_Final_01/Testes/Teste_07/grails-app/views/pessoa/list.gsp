			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="end" title="${message(code: 'pessoa.end.label', default: 'End')}" />
						...
						<g:sortableColumn property="tel" title="${message(code: 'pessoa.tel.label', default: 'Tel')}" />
				...
				<g:each in="${pessoaInstanceList}" status="i" var="pessoaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${pessoaInstance.id}">${fieldValue(bean: pessoaInstance, field: "end")}</g:link></td>
					
						<td>${fieldValue(bean: pessoaInstance, field: "idade")}</td>
					
						<td>${fieldValue(bean: pessoaInstance, field: "nome")}</td>
					
						<td>${fieldValue(bean: pessoaInstance, field: "tel")}</td>
