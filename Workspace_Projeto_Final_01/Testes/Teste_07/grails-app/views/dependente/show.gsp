	...
	<body>
		...
		<div id="show-dependente" class="content scaffold-show" role="main">
			...
			<ol class="property-list dependente">
				...
				<g:if test="${dependenteInstance?.end}">
				<li class="fieldcontain">
					<span id="end-label" class="property-label"><g:message code="dependente.end.label" default="End" /></span>
					
						<span class="property-value" aria-labelledby="end-label"><g:fieldValue bean="${dependenteInstance}" field="end"/></span>
