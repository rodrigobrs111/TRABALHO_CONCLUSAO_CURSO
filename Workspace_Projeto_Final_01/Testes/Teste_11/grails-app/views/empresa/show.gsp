	...
	<body>
		...
		<div id="show-empresa" class="content scaffold-show" role="main">
			...
			<ol class="property-list empresa">
				...
				<g:if test="${empresaInstance?.dono}">
				<li class="fieldcontain">
					<span id="dono-label" class="property-label"><g:message code="empresa.dono.label" default="Dono" /></span>
					
						<span class="property-value" aria-labelledby="dono-label"><g:link controller="dono" action="show" id="${empresaInstance?.dono?.id}">${empresaInstance?.dono?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${empresaInstance?.num}">
				<li class="fieldcontain">
					<span id="num-label" class="property-label"><g:message code="empresa.num.label" default="Num" /></span>
					
						<span class="property-value" aria-labelledby="num-label"><g:fieldValue bean="${empresaInstance}" field="num"/></span>
