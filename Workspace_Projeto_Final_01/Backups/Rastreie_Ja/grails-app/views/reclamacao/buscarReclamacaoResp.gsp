...
<body>
	...
	<g:form url="[action:'buscarReclamacaoResp',controller:'reclamacao']" method = "post" >
			Número da Reclamação: <input type = "text"                   name   = "numReclamacao" /><br/>
						          <input type = "submit"                 value  = "Buscar" onclick="return confirm('${message(code: 'Tem certeza que deseja encerrar a reclamação?', default: 'Tem certeza que deseja encerrar a reclamação?')}');" >
	</g:form><br/><br/><br/><br/>
...
<table class="table table-bordered">
     ...
     Resposta">
        ...
        <textarea name="comentario" value="comentario" rows="4" cols="20" ></textarea><br/>
