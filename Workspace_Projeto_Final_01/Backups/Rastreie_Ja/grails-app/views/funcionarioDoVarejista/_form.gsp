<%@ page import="dominio.FuncionarioDoVarejista" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: funcionarioDoVarejistaInstance, field: 'supervisorDoVarejista', 'error')} required">
				<label for="supervisorDoVarejista" class="control-label"><g:message code="funcionarioDoVarejista.supervisorDoVarejista.label" default="Supervisor Do Varejista" /><span class="required-indicator">*</span></label>
				<div class="controls">
					<g:select id="supervisorDoVarejista" name="supervisorDoVarejista.id" from="${dominio.SupervisorDoVarejista.list()}" optionKey="id" required="" value="${funcionarioDoVarejistaInstance?.supervisorDoVarejista?.id}" class="many-to-one"/>
					<span class="help-inline">${hasErrors(bean: funcionarioDoVarejistaInstance, field: 'supervisorDoVarejista', 'error')}</span>
				</div>
			</div>
