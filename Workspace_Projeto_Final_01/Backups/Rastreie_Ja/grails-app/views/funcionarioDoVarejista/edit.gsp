...
<section id="edit-funcionarioDoVarejista" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${funcionarioDoVarejistaInstance?.id}" />
		<g:hiddenField name="version" value="${funcionarioDoVarejistaInstance?.version}" />
		<fieldset class="form">
